...
export default function Story() {
    return (
        <section className="w-full flex justify-center bg-white md:hidden font-Inter18Semibold">
            <div className="relative w-full max-w-[360px] h-[655px] md:max-w-[500px] md:h-[750px] mt-10 mb-10">
                ...
                <div className="relative z-10 flex flex-col items-center text-center text-white px-6 py-8 h-full">
                    <h2 className="uppercase tracking-widest text-3xl font-GemunuExtraBold md:text-2xl leading-tight">
                        RESERVED ONLY <br />
                        FOR THE <br />
                        MOTIVATED
                    </h2>
                    ...
                    <p className="mt-4 text-[14px] md:text-sm leading-relaxed font-semibold max-w-[280px] md:max-w-[360px]">
                    ...
                    <Link
                        href="/about"
                        className="mt-auto inline-flex bg-white text-black px-6 py-3 text-xs font-semibold tracking-widest items-center gap-2 hover:bg-black hover:text-white border border-white transition"
                    >
                        CITEȘTE MAI MULTE
